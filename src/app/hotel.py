...
class Hotel:
    ...
    def list_hotels(self):
        ...
        for hotel in self.database.get_all_hotels():
            print(
    ...
    def list_hotel_room_types(self, hotel_id):
        room_types = self.database.get_hotel_room_types(hotel_id)
    ...
    def list_room_types(self):
        room_types = self.database.get_room_types()
    ...
    def hotel_info(self):
        ...
        hotel = self.database.get_hotel_address(hotel_id)
    ...
    def cost_statistics(self):
        costs = self.database.get_min_max_avg_cost()
    ...
    def list_hotels_by_popularity(self):
        ...
        hotels = self.database.get_hotels_popularity()
        for hotel in hotels:
            if hotel['bookings'] == 1:
    ...
    def list_room_types_by_popularity(self):
        ...
        room_types = self.database.get_room_types_popularity()
        for room_type in room_types:
    ...
    def list_dining_options_by_popularity(self):
        ...
        dining_options = self.database.get_dining_options_popularity()
        for dining_option in dining_options:
    ...
    def list_payment_methods_by_popularity(self):
        ...
        payment_methods = self.database.get_payment_methods_popularity()
        for payment_method in payment_methods:
